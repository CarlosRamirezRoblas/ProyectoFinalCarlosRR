    ...
    <div class="p-5">
        <form class="form" role="form" method="post" action="Operaciones">
            <div class="form-group">
                <label>Id</label>
                <input type="text" name="idUsuario" value="${dentista.idUsuario}" readonly/>
            </div>
            <div class="form-group">
                <p><c:out value="Nombre: ${dentista.nombre}" default="El dentista tiene que insertar sus datos."/></p> 
            </div>
